...
export default function Forms() {
  ...
  const [formData, setFormData] = React.useState({}); // State to store form data
      ...
      content: (
        <div>
          ...
          <FormControl fullWidth margin="normal" variant="outlined">
            ...
            <Select label="Are you already insured in Switzerland?">
          ...
          <FormControl fullWidth margin="normal" variant="outlined">
            ...
            <Select label="Which situation applies to you?">
          ...
          <FormControl fullWidth margin="normal" variant="outlined">
            ...
            <Select label="Same insurance model?">

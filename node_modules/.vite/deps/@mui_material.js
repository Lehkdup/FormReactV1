...
} from "./chunk-OFPVZ7HV.js";
import {
  Step_default,
  getStepUtilityClass,
  stepClasses_default
} from "./chunk-TU6NUXNV.js";
import {
  Container_default,
  containerClasses_default,
  getContainerUtilityClass
} from "./chunk-UCRLNWCI.js";
import {
  Divider_default,
...
} from "./chunk-WWOFKUUX.js";
import {
  StepContext_default,
  StepperContext_default,
  useStepContext,
  useStepperContext
} from "./chunk-CAOPYFBP.js";
import {
...
} from "./chunk-FRAOTJWZ.js";
import {
  init_useEventCallback,
  init_useIsFocusVisible,
  useEventCallback_default,
  useIsFocusVisible_default
} from "./chunk-X3P4YH6G.js";
import {
  Transition_default
...
var StepButton = React102.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React102.cloneElement(children, childProps) : (0, import_jsx_runtime124.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var SwipeableDrawer = React104.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime127.jsxs)(React104.Fragment, {
...
var Tab = React106.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime130.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime130.jsxs)(React106.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime130.jsxs)(React106.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
var Tabs = React125.forwardRef(function Tabs2(inProps, ref) {
  ...
  const [displayStartScroll, setDisplayStartScroll] = React125.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React125.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React125.useState(false);
...
var ToggleButtonGroupContext = React126.createContext({});
if (true) {
...
var ToggleButtonGroupButtonContext = React127.createContext(void 0);
if (true) {
...
var ToggleButton = React128.forwardRef(function ToggleButton2(inProps, ref) {
  const _React$useContext = React128.useContext(ToggleButtonGroupContext_default), {
    value: contextValue
  } = _React$useContext, contextProps = _objectWithoutPropertiesLoose(_React$useContext, _excluded96);
  const toggleButtonGroupButtonContextPositionClassName = React128.useContext(ToggleButtonGroupButtonContext_default);
...
var ToggleButtonGroup = React129.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiToggleButtonGroup"
  });
  ...
  const handleChange = React129.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React129.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
    onChange(event, value === buttonValue ? null : buttonValue);
  }, [onChange, value]);
  const context = React129.useMemo(() => ({
    className: classes.grouped,
...
function useScrollTrigger(options = {}) {
  ...
  const store = React130.useRef();
  const [trigger, setTrigger] = React130.useState(() => getTrigger(store, other));
  React130.useEffect(() => {
    const handleScroll = () => {
